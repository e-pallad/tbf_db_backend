<?php 
    ...
    if ($table == 'RI-TBF_SEF_Apparateliste') {
        ...
        $query = "SELECT `Revit_ID` AS 'ID', `FamilyAndType`,`Revit_Type`, `Benennung` AS 'Bezeichnung', `R&I EB68-Nr.` AS 'Plannummer R+I', CONCAT(`AKZ_Gr1_Standort`,'.',`AKZ_Gr2_Anlagenteil`,'.',`AKZ_Gr3_Aggregat`,'.',`AKZ_Gr4_Nummer`,'.',`AKZ_Gr5_Aggregat`,'.',`AKZ_Gr6_Nummer`) AS 'AKZ',`TBF_ID` AS 'Element ID' FROM `Gesamtdatenbank`";
