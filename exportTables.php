<?php 
    ...
    if ($table == 'RI-TBF_SEF_Apparateliste') {
        ...
        $query = "SELECT `AKZ_Gr1_Standort`,`AKZ_Gr2_Anlagenteil`,`AKZ_Gr3_Aggregat`,`AKZ_Gr4_Nummer`, `AKZ_Gr5_Aggregat`, `AKZ_Gr6_Nummer`, `Benennung`, `Benennung Zusatz`, `NW`, `PN`, `TBV/ITD Nr.`, `Einbauort bzw. Rohrleitungs Nr.`, `R&I EB68-Nr.`, `Feld-Nr.`, `Zchn. Rev. Nr.`, `Bemerkung`, `Zustand/Bearbeitung` FROM `Gesamtdatenbank` WHERE `AKZ_Gr4_Nummer` > 0";
        ...
        $query = "SELECT `Revit_ID` AS 'ID', `FamilyAndType`,`Revit_Type` AS 'Type', `Benennung` AS 'Bezeichnung', `R&I EB68-Nr.` AS 'Plannummer R+I', CONCAT_WS('.',`AKZ_Gr1_Standort`,`AKZ_Gr2_Anlagenteil`,`AKZ_Gr3_Aggregat`,`AKZ_Gr4_Nummer`,`AKZ_Gr5_Aggregat`,`AKZ_Gr6_Nummer`) AS 'AKZ',`TBF_ID` AS 'Element ID' FROM `Gesamtdatenbank` WHERE `Revit_ID` IS NOT NULL";
