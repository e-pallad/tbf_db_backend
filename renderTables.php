<?php 
    ...
    if ($table == 'RI-TBF_SEF_Apparateliste') {
        ...
        # $query = "SELECT `Index`, `Klasse`, `Benennung`, `Medium`, `R&I EB68-Nr.` AS `Zeichnung`, `TBF_ID`, `AKZ_Gr1_Standort`, `AKZ_Gr2_Anlagenteil`, `AKZ_Gr3_Aggregat`, `AKZ_Gr4_Nummer`, `AKZ_Gr5_Aggregat`, `AKZ_Gr6_Nummer`, `Anlage`, `Benennung`, `Geschoss`, `Hersteller`, `Index`, `Klasse`, `Massenstrom`, `Nennleistung`, `Nennspannung`, `Nennstrom`, `Signalart`, `Typ`, `Volumen` FROM `Gesamtdatenbank`;";
