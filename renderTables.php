<?php 
    ...
    if ($table == 'RI-TBF_SEF_Apparateliste') {
        ...
        $query = "SELECT `TBF_ID`,`Komponente`,`Reserve_1`,`Reserve_2`,`Reserve_3`,`AKZ_Gr1_Standort`,`AKZ_Gr2_Anlagenteil`,`AKZ_Gr3_Aggregat`,`AKZ_Gr4_Nummer`,`AKZ_Gr5_Aggregat`,`AKZ_Gr6_Nummer`,`Benennung`,`Benennung Zusatz`,`Hersteller`,`Typ`,`Zustand/Bearbeitung` FROM `Gesamtdatenbank`";
        ...
        $query = "SELECT `Revit_ID`,`FamilyAndType`,`Revit_Type` AS 'Type', `Benennung`, `R&I EB68-Nr.` AS 'Plannummer R+I', `AKZ_Gr1_Standort`,`AKZ_Gr2_Anlagenteil`,`AKZ_Gr3_Aggregat`,`AKZ_Gr4_Nummer`,`AKZ_Gr5_Aggregat`,`AKZ_Gr6_Nummer`,`Länge [m]` ,`Breite`,`Höhe`,`Radius`,`Ebene`,`TBF_ID` FROM `Gesamtdatenbank` WHERE `Revit_ID` IS NOT NULL";
